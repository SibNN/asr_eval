...
class YandexSpeechKitWrapper(TimedTranscriber):
    ...
    def __init__(
        ...
        api_key: str,
        model: (
            Literal['general', 'general:rc', 'general:deprecated']
        ) = 'general',
        ...
        self.model.audio_processing_type = (
            AudioProcessingType[audio_processing]
        )
        self.normalize = normalize

    @override
    def timed_transcribe(self, waveform: FLOATS) -> list[TimedText]:
        results = self.model.transcribe(waveform_to_bytes(waveform))
