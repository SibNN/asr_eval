...
class CorrectorLangchain(TranscriptionCorrector):
    ...
    def __init__(
        ...
        # use_web_search disabled by default,
...
def _ignore_warnings_specially_for_duckduckgo():
    # duckduckgo_search sets warnings.simplefilter('ignore') and then prints
    # a warning "This package (`duckduckgo_search`) has been renamed to
    # `ddgs`! Use `pip install ddgs` instead."
    warnings.filterwarnings(
        "ignore", message=r'.*has been renamed to `ddgs`.*'
    )
